...
/**
 * Boundary específico para el subtree /app. Si pilla un ChunkLoadError
 * (típico al cargar /app justo después de un deploy nuevo), recarga
 * con cache-buster. Para cualquier otro error muestra un fallback
 * mínimo con botón de reintento.
 */
